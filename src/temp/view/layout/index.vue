...
<script>
import Aside from '@/views/view/layout/aside'
import HistoryComponent from '@/views/view/layout/aside/historyComponent/history'
import Screenfull from '@/views/view/layout/screenfull'
import Search from '@/views/view/layout/search/search'
import BottomInfo from '@/views/view/layout/bottomInfo/bottomInfo'
import { mapGetters, mapActions } from 'vuex'
import CustomPic from '@/components2/customPic'
export default {
  name: 'Layout',
  data() {
    return {
