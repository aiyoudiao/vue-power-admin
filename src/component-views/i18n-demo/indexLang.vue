<template>
  <div>
    ...
    <el-row :gutter="20" style="margin:100px 15px 50px;">
      <el-col :span="12">
        <div class="block">
          <el-date-picker v-model="date" type="date" :placeholder="$t('i18nView.datePlaceholder')" />
        </div>
        <div class="block">
          <el-pagination
            background
      ...
      <el-col :span="12">
        <el-table :data="tableData" fit highlight-current-row border style="width: 100%">
          <el-table-column prop="name" :label="$t('i18nView.tableName')" width="100" align="center" />
          <el-table-column prop="date" :label="$t('i18nView.tableDate')" width="120" align="center" />
