...
import {
  ...
  updateAuthority,
  copyAuthority
} from "@/api/api2/authority";

import Menus from "@/views/view/superAdmin/authority/components/menus";
import Apis from "@/views/view/superAdmin/authority/components/apis";
import Datas from "@/views/view/superAdmin/authority/components/datas";
