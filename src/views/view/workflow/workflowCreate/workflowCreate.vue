...
} from "@/api/api2/workflowProcess";  //  此处请自行替换地址
import gvaWfd from "@/components2/gva-wfd";
import { getUserList } from "@/api/api2/user";
import { getAuthorityList } from "@/api/api2/authority";
export default {
  name: "Workflow",
  components: {
    gvaWfd
